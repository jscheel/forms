...
exports.string = function(opt){
    ...
    f.before = opt.before || '';
    f.after = opt.after || '';
    this.wrapAttributes = opt.wrapAttributes || {};
    ...
    f.toHTML = function(name, iterator){
        return f.before + (iterator || forms.render.div)(name, this) + f.after;
    };
...
/*
  TODO this should not be a stub, we should eliminate binding, etc for markup fields entirely
*/
exports.markup = function(opt){
  opt = opt || {};
  var f = {};
  ...
  f.bind = function(){
    ...
    b.data = '';
    b.error = null;
    b.validate = function(form, callback){return callback(null, b)};
